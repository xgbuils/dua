...
var array = [
    ...
    {input: [function(){}],                 output: {type: {name: ''}}},
    {input: [42],                           output: {type: {name: ''}}},
    {input: [true],                         output: {type: {name: ''}}},
    {input: [undefined],                    output: {type: {name: ''}}},
    {input: [null],                         output: {type: {name: ''}}},
    {input: [{type: 'char(7)'}],            output: {type: {name: 'CHAR', params: [7]}}},
    {input: [{foo: 1, bar: 2}],             output: {foo: 1, bar: 2, type: {name: ''}}},
    {input: [{foo: 1, type: ''}],           output: {foo: 1, type: {name: ''}}},
    {input: [{type: {foo: 1, bar:2}}],      output: {type: {name: ''}}},
    {input: [{type: function(){}}],         output: {type: {name: ''}}},
    {input: [{type: 42}],                   output: {type: {name: ''}}},
    {input: [{type: true}],                 output: {type: {name: ''}}},
    {input: [{type: false}],                output: {type: {name: ''}}},
    {input: [{type: undefined}],            output: {type: {name: ''}}},
    {input: [{type: null}],                 output: {type: {name: ''}}},
]

module.exports = {
    'sqlite#columnNormalizer': function(test){
